...
interface ShowtimeModalInfosProps {
    screeningDate: ScreeningDate;
    movie: Movie;
    theater: Theater;
}

export const ShowtimeModalInfos = (props: ShowtimeModalInfosProps) => {
    const { screeningDate, movie, theater } = props;
    ...
    return (
        <div className={style.showtimeWrapper}>
                ...
                <div>
                    <p className={style.date}>
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            />
                            <path d="M1 4.6842H15.3107" stroke="#FFFDEF" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        Date
                    </p>
            ...
            {/* THEATER */}
            <div className={style.theaterRow}>
                <div>
