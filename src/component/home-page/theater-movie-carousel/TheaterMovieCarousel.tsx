...
import style from './TheaterMovieCarousel.module.css';

interface TheaterMovieCarouselProps {
    theaterId: string;
}
...
const TheaterMovieCarousel = (props: TheaterMovieCarouselProps) => {
    ...
    return (
        <CarouselProvider
            ...
            totalSlides={theaterMovies.length}
            step={1}
...
export default TheaterMovieCarousel;
